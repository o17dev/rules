...
export default function PromptList({ initialData }: PromptListProps) {
          ...
          <DialogContent className="max-w-2xl">
            ...
            <div className="space-y-6">
              ...
              <Card className="p-4 space-y-4">
                ...
                <h3 className="mt-4">Libraries</h3>
                <div className="flex flex-wrap gap-2">
                  {selectedContent.libs.map((lib) => (
                    <Badge key={lib.id} variant="secondary">{lib.name}</Badge>
                  ))}
                </div>
              </Card>
